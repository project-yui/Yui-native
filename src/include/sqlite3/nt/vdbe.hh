...
struct NTVdbe {
  ...
  NTVdbe **ppVPrev,*pVNext; /* Linked list of VDBEs with the same Vdbe.db */
  ...
  NTMem *aMem;              /* The memory locations */
  NTMem **apArg;            /* Arguments to currently executing user function */
  void /*VdbeCursor*/ **apCsr;     /* One element of this array for each open cursor */
  NTMem *aVar;              /* Values for the OP_Variable opcode. */
  ...
  ** initialized to zero or NULL */
  ...
  void * t2;
  NTMem *aColName;          /* Column names to return */
  NTMem *pResultRow;        /* Current output row */
